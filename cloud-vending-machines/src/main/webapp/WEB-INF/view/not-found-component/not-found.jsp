...
<a href="https://www.cloudvendingmachines.it">
    ...
    <section class="error">
        ...
        <div class="error__content">
            <div class="error__message message">
                <h1 class="message__title">Pagina non trovata</h1>
                <p class="message__text">Siamo spiacenti, la pagina che stavi cercando non è stata trovata. Il collegamento che hai seguito potrebbe essere interrotto o non esiste più. Si prega di riprovare, fai click tornare alla Homepage.</p>
            </div>
